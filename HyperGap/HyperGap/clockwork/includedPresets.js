            ...
            name: "#loop", code: function (event) {
                ...
                navigator.getGamepads().forEach(function (pad, i) {
                    if (pad) {
                        ...
                        that.engine.execute_event("gamepadAxis", { values: [{ x: axis1X, y: axis1Y }, { x: axis2X, y: axis2Y }] });
                        that.engine.execute_event("gamepadTrigger", { leftValue:buttonLeftTrigger, rightValue: buttonRightTrigger});
