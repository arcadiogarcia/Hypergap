        ...
        },
        {
            name: "onclick", code: function (e) {
                ...
                if (window.innerWidth / CLOCKWORKCONFIG.screenbuffer_width < window.innerHeight / CLOCKWORKCONFIG.screenbuffer_width) {
                    this.collision["point"][1].x = CLOCKWORKCONFIG.screenbuffer_width * this.collision["point"][1].x / window.innerWidth;
                    ...
                    this.collision["point"][1].y = CLOCKWORKCONFIG.screenbuffer_height * (this.collision["point"][1].y - ypos) / height;
                } else {
                    this.collision["point"][1].y = CLOCKWORKCONFIG.screenbuffer_height * this.collision["point"][1].y / window.innerHeight;
                    ...
                    this.collision["point"][1].x = CLOCKWORKCONFIG.screenbuffer_width * (this.collision["point"][1].x - xpos) / width;
                }
